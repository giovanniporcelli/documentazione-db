...
| ---- | ---- | ------- | -------- | -------- | ------- |
| ID | char |  | false | [TF_BLRULE_PARAMETERS](TF_BLRULE_PARAMETERS.md) |  |
...
| ---- | ---- | ---------- |
| PK_BLRULES | PRIMARY KEY | CLUSTERED, unique, part of a PRIMARY KEY constraint, [ ID ] |

## Indexes

| Name | Definition |
| ---- | ---------- |
| PK_BLRULES | CLUSTERED, unique, part of a PRIMARY KEY constraint, [ ID ] |

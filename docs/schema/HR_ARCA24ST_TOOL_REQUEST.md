# HR_ARCA24ST_TOOL_REQUEST

## Description

Arca24 Staging Table: Tool Request - Staging table for data coming from Arca24 - Tool Request data.
...
| TOOL_TYPE_ID | smallint |  | true |  |
| SESSION_ID | nvarchar(20) |  | true |  |
| TITLE | nvarchar(150) |  | true |  |
| DONE | smallint |  | true |  |
| SCORE | nvarchar(MAX) |  | true |  |
| PASSED | smallint |  | true |  |
...
| ---- | ---- | ---------- |
| PK_HR_ARCA24ST_TOOL_REQUEST | PRIMARY KEY | CLUSTERED, unique, part of a PRIMARY KEY constraint, [ ID ] |

## Indexes

| Name | Definition |
| ---- | ---------- |
| PK_HR_ARCA24ST_TOOL_REQUEST | CLUSTERED, unique, part of a PRIMARY KEY constraint, [ ID ] |
| IDX_A24ST_TOOLREQ_INSERT_TIME | NONCLUSTERED, [ INSERT_TIME, STATUS ] |

## Relations

![er](HR_ARCA24ST_TOOL_REQUEST.svg)
